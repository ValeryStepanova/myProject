...
public class Printer {
    ...
    public static void printSelectEntityMessage() {System.out.println("1.House\n" + "2.Door\n" + "0.Exit");}
    public static void printEnterId() {System.out.println("Please, enter id");}
    public static void printEnterSize() {System.out.println("Please, enter size");}
    public static void printEnterType() {System.out.println("Please, enter type");}
    public static void printEnterColor() {System.out.println("Please, enter color");}
    public static void printEnterRoomCount() {System.out.println("Please, enter count of room");}
    ...
    public static void printNotFoundMessage(){ System.out.println("404 Not found");}
}
